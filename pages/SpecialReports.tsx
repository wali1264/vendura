...
const SpecialReports: React.FC = () => {
    ...
    const handleDownload = () => {
        ...
        if (format === 'excel') {
            ...
            const doc = new jsPDF();
            // Note: Persian support in jsPDF requires custom fonts. 
            // For now, we use standard autoTable which might have issues with RTL/Persian 
            // but provides a structured layout.
